...
void VRSMOKEVIS_API ClearVolumeTexture_RenderThread(
	FRHICommandListImmediate& RHICmdList, FRHITexture3D* ALightVolumeResource, float ClearValue);

void VRSMOKEVIS_API Clear2DTexture_RenderThread(
...
{
	DECLARE_EXPORTED_SHADER_TYPE(FClearFloatRWTextureCS, Global, VRSMOKEVIS_API);
...
{
	DECLARE_EXPORTED_SHADER_TYPE(FClearVolumeTextureShaderCS, Global, VRSMOKEVIS_API);
