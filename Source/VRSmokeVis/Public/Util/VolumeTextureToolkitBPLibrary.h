 ...
 */
UCLASS()
class VRSMOKEVIS_API UVolumeTextureToolkitBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	 ...
	 * IVolumeLoader.*/
	UFUNCTION(BlueprintCallable, meta = (Keywords = "Load Volume MHD"), Category = "VolumeTextureToolkit")
